...
**Why total, not consecutive:** the #24 circuit breaker (6 consecutive) never fired on 2026-08-10 — the incident turn failed at scattered iterations (9 total, including bursts of 4 and 3), each burst broken by a successful call. A model alternating success and malformed markers degrades just as surely as one stuck in a streak.
