...
// loadPlaybookPersona resolves workspace-owned personas first. A missing
// workspace file falls back to the shared roster so legacy playbooks continue
// to work while migration is in progress; malformed workspace files fail
// loudly instead of silently selecting a different persona.
